  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        linkedin: 'border-transparent bg-blue-600 text-white',
        twitter: 'border-transparent bg-sky-500 text-white',
        instagram: 'border-transparent bg-pink-600 text-white',
        ...
        skipped: 'border-transparent bg-red-100 text-red-700',
      },
    },
    defaultVariants: {
      variant: 'default',
